...
CREATE TABLE `users` (
    ...
    `assignedDeptIds` JSON NULL,
    `activeAssignments` JSON NULL,
    `sideDeptId` VARCHAR(191) NULL,
...
CREATE TABLE `salary_formulas` (
    ...
    `targetField` VARCHAR(191) NULL DEFAULT '',
